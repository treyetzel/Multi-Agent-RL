...
# TODO: add hyperbolic train function here
...
def test(env, num_episodes, q):
    ...
    return sum(score / num_episodes) #TODO: doesn't represent competitive games where each agent has its own score


def run_idqn(env_name, lr, gamma, batch_size, buffer_limit, log_interval, max_episodes,
         max_epsilon, min_epsilon, test_episodes, warm_up_steps, update_iter, monitor=False,USE_WANDB=False):
    ...
    for episode_i in range(max_episodes):
        ...
        if memory.size() > warm_up_steps:
            # TODO: call hyperbolic train function here?
